...
namespace PP_07_02_25
{
    ...
    class Class2
    {
        ...
        {
            Employee manager = new Manager("Manager", 101, 75000, 10);
            Employee developer = new Developer("Developer", 102, 60000, "C#");
            Employee intern = new Intern("Intern", 103, 20000, "4 months");
