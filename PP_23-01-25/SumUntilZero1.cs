...
class SumUntilZero1
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Enter numbers to add to the total. Enter 0 or -ve number to stop:");

        // Use a while loop to calculate the sum until the user enters 0 or -ve number
        while (true)
        {
